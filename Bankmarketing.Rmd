...
Test several models (logistic regression, random forest, linear SVC) using bootstrapped cross validation to optimize tuning variables
...
Logistic regression identifies a higher percentage of "yes" (subscribing to term deposits) clients, but has a lower overall accuracy than the random forest. This is because the rate of false "yes" predictions is twice as high for the logistic regression model.
