...
While the decision tree model "leaves money on the table" in that it doesn't predict as many of the customers who will make a term deposit. But the bank is not a doctor trying to catch every possible instance of cancer, instead it is trying to maximize profit. The cost to the bank to make one call divided by the average revenue generated by a successful call is the cost-to-revenue ratio. To recoup the cost of making calls, this ratio cannot exceed the success rate of the calls made. From this standpoint, using the decision tree model to choose which customers to call will maximize the profit as long as the cost-to-revenue ratio stays below 0.4
...
plot(x=1,y=1,ylab="Cost-To-Revenue Ratio",xlab="Call Success Rate",xlim=c(0.035,1),ylim=rev(c(0.035,1)))
...
Make the call if the nr.employed<69 or if the emp.var.rate<-0.64
